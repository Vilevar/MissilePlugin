...
//		l.getWorld().createExplosion(l, this.explosionPower, this.explosionSetFire, this.explosionBreakBlocks, this.launcher);
//		this.exploded = true;
//		
...
//	}
//	
//	private Vector getTanVector() { // Should do (todo)
