...
//	private BalisticMissile missile;
	...
	public boolean isLaunchingConfirmed() {
		return false; //this.missile!=null;
	}
...
//		}
	...
	private double getMissileDataRadius() {
		return 0; // this.missileData.getWeight()*this.missileData.getSpeed()*this.missileData.getSpeed() / this.missileData.getRotatingForce();
	}
